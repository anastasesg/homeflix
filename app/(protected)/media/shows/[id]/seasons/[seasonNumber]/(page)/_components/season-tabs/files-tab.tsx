...
function formatEpisodeBadge(episodeNumber: number): string {
  ...
  return (
    <div className="flex flex-col items-center justify-center rounded-xl border border-dashed border-border/50 bg-muted/20 py-16 text-center">
      ...
      <p className="mt-2 max-w-xs text-sm text-muted-foreground">
        No episode files have been downloaded for this season yet.
      </p>
  ...
  return (
    <Query
      ...
      callbacks={{
        ...
        error: () => null,
        success: (allFiles) => <FilesTabContent files={allFiles.filter((f) => f.seasonNumber === seasonNumber)} />,
      }}
    />
  );
}
