...
function ManageTabContent({ libraryInfo }: { libraryInfo: ShowLibraryInfo }) {
    ...
    <div className="space-y-6">
      ...
      <div className="grid gap-4 sm:grid-cols-2">
        ...
        <SettingCard
          ...
          title="Monitoring"
          description="Automatically search for new episodes"
        >
      ...
      {libraryInfo.path && (
        <div className="rounded-xl border border-border/40 bg-gradient-to-br from-muted/20 to-transparent p-5">
          <div className="flex gap-4">
            <div className="flex size-10 shrink-0 items-center justify-center rounded-lg bg-muted/20 text-muted-foreground">
              <FolderOpen className="size-5" />
            </div>
            <div className="min-w-0 flex-1">
              <h3 className="font-semibold">File Path</h3>
              <p className="mt-1 truncate font-mono text-sm text-muted-foreground" title={libraryInfo.path}>
                {libraryInfo.path}
              </p>
            </div>
          </div>
